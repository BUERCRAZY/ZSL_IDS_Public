...
# 定义kdd99数据预处理函数
def preHandel_data():
    source_file = 'E:/pythonworkspace/ZSL_IDS/Data/kddcup.data/kddcup.data.corrected'
    handled_file = 'E:/pythonworkspace/ZSL_IDS/Data/kddcup.data/kddcup.data.corrected.csv'
