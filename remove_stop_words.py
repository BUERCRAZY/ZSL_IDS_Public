...
def movestopwords(sentence):
    stopwords = stopwordslist('E:/pythonworkspace/ZSL_IDS/corpus/stop_words.txt')
    outstr = ''
...
if __name__ == '__main__':
    ...
    corpus_path = "E:/pythonworkspace/ZSL_IDS/corpus/train/"  # 未分词路径
    seg_path = "E:/pythonworkspace/ZSL_IDS/corpus/train_seg/"  # 分词后分类语料库路径
